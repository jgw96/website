...
export class ComponentTables {
  ...
  render() {
    return (
      <section class="button-demo">
        ...
        <demo-markup language="html" code={`<table class="c-table">
  ...
  <tbody class="c-table__body">
    ...
    <tr class="c-table__row">
      ...
      <td class="c-table__cell">@comms</td>
        ...
        <demo-markup language="html" code={`<table class="c-table c-table--striped">
  ...
  <tr class="c-table__row">
    ...
    <td class="c-table__cell">@comms</td>
        ...
        <demo-markup language="html" code={`<table class="c-table c-table--clickable">
  ...
  <tr class="c-table__row">
    ...
    <td class="c-table__cell">@comms</td>
        ...
        <demo-markup language="html" code={`<table class="c-table c-table--condensed">
  ...
  <tr class="c-table__row">
    ...
    <td class="c-table__cell">@comms</td>
        ...
        <demo-markup language="html" code={`<div class="c-table c-table--striped">
