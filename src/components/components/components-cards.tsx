...
export class ComponentsCards {
  ...
  <div class="c-card__item c-card__item--divider">Footer</div>
            ...
            <demo-markup language="html" code={`<div class="c-card">
  <div class="c-card__item c-card__item--divider c-card__item--brand">Header</div>
  <div class="c-card__body c-card__item--info">
    <p class="c-paragraph">Lorem ipsum dolor sit amet, feugiat corpora ex eam. Inciderint eloquentiam sea et.</p>
    <p class="c-paragraph">Lorem ipsum dolor sit amet, feugiat corpora ex eam. Inciderint eloquentiam sea et.</p>
  </div>
  <div class="c-card__item c-card__item--divider c-card__item--warning">Divider</div>
  <div class="c-card__body c-card__item--success">
    <p class="c-paragraph">Lorem ipsum dolor sit amet, feugiat corpora ex eam. Inciderint eloquentiam sea et.</p>
    <p class="c-paragraph">Lorem ipsum dolor sit amet, feugiat corpora ex eam. Inciderint eloquentiam sea et.</p>
  </div>
  <div class="c-card__item c-card__item--divider c-card__item--error">Footer</div>
</div>`} />
  ...
  <div class="c-card__item">Item 8</div>
          ...
          <blaze-tab header="JavaScript">
            <demo-markup language="html" code={`<blaze-card>
