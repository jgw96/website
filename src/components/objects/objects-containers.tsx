...
$screen-width-super:   116em;`}
        ...
        <p class="c-paragraph">
          Each container can also be applied at certain screen sizes. <code class="c-code">.o-container--small@large</code> for example
          will restrict the horizontal width to small when the viewport has a large or more width. Each size container has an
          xsmall, small, medium, large, xlarge and super responsive suffix.
        </p>

        <h3 id="xsmall" class="c-heading u-large c-text--mono">.o-container--xsmall</h3>
        ...
        <h3 id="small" class="c-heading u-large c-text--mono">.o-container--small</h3>
        ...
        <h3 id="medium" class="c-heading u-large c-text--mono">.o-container--medium</h3>
        ...
        <h3 id="large" class="c-heading u-large c-text--mono">.o-container--large</h3>
        ...
        <h3 id="xlarge" class="c-heading u-large c-text--mono">.o-container--xlarge</h3>
        ...
        <h3 id="super" class="c-heading c-text--mono">.o-container--super</h3>
