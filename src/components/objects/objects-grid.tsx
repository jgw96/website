...
export class ObjectsGrid {
  ...
  render() {
    return (
      <page-template name={this.name}>
        ...
        <h2 id="basic" class="c-heading u-xlarge">Basic Grid</h2>
        <p class="c-paragraph">
  ...
  <div class="o-grid__cell">
    <div class="o-grid-text">third</div>
        ...
        <h2 id="widths" class="c-heading u-xlarge">Widths</h2>
        <p class="c-paragraph">
  ...
  <div class="o-grid__cell">
    <div class="o-grid-text">third</div>
        ...
        <h2 id="offsets" class="c-heading u-xlarge">Offsets</h2>
        <p class="c-paragraph">
  ...
  <div class="o-grid__cell o-grid__cell--width-20 o-grid__cell--offset-60">
    <div class="o-grid-text">second</div>
        ...
        <h2 id="wrapping" class="c-heading u-xlarge">Wrapping</h2>
        <p class="c-paragraph">
  ...
  <div class="o-grid__cell o-grid__cell--width-66">
    <div class="o-grid-text">second</div>
        ...
        <h2 id="nesting" class="c-heading u-xlarge">Nesting</h2>
        <p class="c-paragraph">
  ...
  <div class="o-grid-text">fifth</div>
        ...
        <h3 id="vertical-alignment-per-cell" class="c-heading u-large">Per <span class="mono">.o-grid__cell</span></h3>
        <p class="c-paragraph">
  ...
  <div class="o-grid__cell">
    <div class="o-grid-text">fourth
      ...
      <br/>
        ...
        <h2 id="responsiveness" class="c-heading u-xlarge">Responsiveness</h2>
        <p class="c-paragraph">
        ...
        <p class="c-paragraph">
          The grid has a <span class="loud">fit</span> or <span class="loud">full</span> class modifier that is used at different screen sizes.
        </p>
        <p class="c-paragraph">
    ...
    <div class="o-grid__cell">
      <div class="o-grid-text">third</div>
        ...
        <h2 id="responsive-suffixes" class="c-heading u-xlarge">Responsive Suffixes</h2>
        <p class="c-paragraph">
          As well as grid level responsiveness you also have control over the cells within a grid.
        </p>
        <p class="c-paragraph">
          Individual cells can change width at specific break points by using <a href="http://csswizardry.com/2015/08/bemit-taking-the-bem-naming-convention-a-step-further/#responsive-suffixes" class="c-link">
            responsive suffixes
          </a>.
        </p>
  ...
  <div class="o-grid__cell o-grid__cell--width-100 o-grid__cell--width-33@large">
    <div class="o-grid-text">large</div>
        ...
        <p class="c-paragraph">
          The suffixes apply to the screen sizes <em class="c-text--loud">and up</em>, in a mobile first manner. In other words:
        </p>
        <p class="paragraph c-text--mono">
          Set cell width to 33% when screen width is greater than or equal to xsmall | small | medium | large | xlarge | super
        </p>

        <h2 id="gutters" class="c-heading u-xlarge">Gutters</h2>
        <p class="c-paragraph">
  ...
  <div class="o-grid__cell o-grid__cell--no-gutter">
    <div class="o-grid-text">third</div>
        ...
        <h2 id="fixed-widths" class="c-heading u-xlarge">Fixed widths</h2>
        <p class="c-paragraph">
